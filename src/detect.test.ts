...
describe('isExpress', () => {
  it('should return true for a valid Express req/res pair', () => {
    const req: any = {
      app: {},
      headers: {},
    };
  ...
  it('should return false if res is not an object', () => {
    const req: any = {
      app: {},
      headers: {},
    };
  ...
  it('should return false if req.app is undefined', () => {
    const req: any = {
      headers: {},
    };
    const res: any = {
  ...
  it('should return false if req.headers is undefined', () => {
    const req: any = {
      app: {},
    };
    const res: any = {
  ...
  it('should return false if res.setHeader is not a function', () => {
    const req: any = {
      app: {},
      headers: {},
    };
  ...
  it('should return false if res.send is not a function', () => {
    const req: any = {
      app: {},
      headers: {},
    };
  ...
  it('should return false for a Fastify-like req/res', () => {
    const req: any = {
      server: {},
      raw: {},
      id: '123',
...
describe('isFastify', () => {
  ...
  it('should return false if req.server is missing', () => {
    const req: any = {
      raw: {},
      id: '123',
    };
  ...
  it('should return false if req.server is falsy', () => {
    const req: any = {
      server: null,
      raw: {},
      id: '123',
  ...
  it('should return false if req.server is not an object', () => {
    const req: any = {
  ...
  it('should return false if req.raw is not an object', () => {
    const req: any = {
      server: {},
      raw: undefined,
      id: '123',
  ...
  it('should return false if req.id is undefined', () => {
    const req: any = {
      server: {},
      raw: {},
    };
  ...
  it('should return true if req.id is 0 (falsy but defined)', () => {
    const req: any = {
      server: {},
      raw: {},
      id: 0,
...
describe('isHono', () => {
  ...
  it('should return false if req.header is not a function', () => {
    const req: any = {
  ...
  it('should return false if req.header is missing', () => {
    const req: any = {
      res: {},
    };
  ...
  it('should return false if req.res is undefined', () => {
    const req: any = {
      header: jest.fn(),
    };
  ...
  it('should return true if req.res is null (defined but falsy)', () => {
    const req: any = {
      header: jest.fn(),
      res: null,
    };
