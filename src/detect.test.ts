import { isExpress, isFastify, isHono } from './detect';
...
describe('isExpress', () => {
  ...
  it('should return false when req is not an object', () => {
    ...
    expect(isExpress(123, res)).toBe(false);
  ...
  it('should return false when both res.setHeader and res.send are missing', () => {
    const req = {
      app: {},
      headers: {},
    };
...
describe('isFastify', () => {
  ...
  it('should return true when req.id is falsy but defined (e.g. 0 or empty string)', () => {
    const req = {
      server: {},
      raw: {},
      id: 0,
